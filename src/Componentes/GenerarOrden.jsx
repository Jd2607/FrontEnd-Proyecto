...
export function GenerarOrden(){
  ...
  const idChangeHandler = () => { 
    ...
    const formato = /^[0-9]+$/
    const valido = formato.test(id)


    if ((id.length < 5) || (!valido) || (id.length > 12)) {
      if (id.length < 5) {
        setError5("La longitud minima es de 5 caracteres.")
      } else if (id.length > 12) {
        setError5("La longitud maxima es de 12 caracteres.")
      } else if (!valido){
        setError5("Use unicamente numeros")
      } 
    } else {
        setError5(null)
    }
  ...
  function submitHandler(){
    ...
    const idCliente = parseInt(idRef.current.value)
    const producto = productoRef.current.value.trim()
    ...
    if ((cliente === "") || (producto === "") || (peso === "") || (idCliente === "") || (origen === "") || (destino === "") 
    ...
    if ((error1) || (error2) || (error3) || (error4) || (error5) || (error6) || (error7) || (error8) || (vacio)){
      setAlerta(true)
      ...
      fetch("http://localhost:8081/orden/nueva-orden",{
        ...
        method:"POST",
        body: JSON.stringify({id,cliente,idCliente,producto,peso,descripcion,vehiculos,origen,destino,valor,distancia})
      })
      .then(data => data.json())
                              ...
                              <div className="row justify-content-end">
                                  <div className="col">
                                      ...
                                      <div id="descripcion">
                                          ...
                                          <div className="col-9">
                                          <textarea name="descripcion" className="form-control" maxLength="100" rows="7" 
                                          cols="50" onChange={descripcionChangeHandler} />
                                          </div>
                                          </div>
                                          <div>
                                  ...
                                  <div className="col">
                                      <div id="identificacion" style={{marginBottom:"40px"}}>
                                          <div className="input-group input-group-outline my-0">
                                          <div className="col-2 align-self-center" style={{marginRight:"10px"}} ><label>#ID: </label></div>
                                          <div className="col-9">
                                          <input ref={idRef} type="number" className="form-control form-control-lg"  
                                          onChange={idChangeHandler} maxLength="12" name="identificacion" /> 
                                          </div> 
                                          </div>
                                          <div>
                                      ...
                                      <div id="vehiculos" style={{marginBottom:"40px"}}>
                                          <div className="input-group input-group-outline my-0">
                                      ...
                                      <div id="direccionOrigen" style={{marginBottom:"40px"}}>
                                          <div className="input-group input-group-outline my-0">
