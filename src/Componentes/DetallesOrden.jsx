          ...
          <Modal.Body>
            <table className="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <th className="table-active">ID cliente</th>
                        <th>{orden.idCliente}</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th><textArea rows="4" cols="30" style={{border: "none", textAlign: "center"}}>{orden.descripcion}</textArea></th>
                    </tr>
                    <tr>
