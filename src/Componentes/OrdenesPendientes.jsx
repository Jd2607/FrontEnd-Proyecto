...
import {faXmark, faCheck, faHashtag, faUser, faIdBadge, faPeopleCarryBox, faMapLocationDot} from '@fortawesome/free-solid-svg-icons'
                            ...
                            <table className="table">
                                <thead>
                                    <tr className="table-active">
                                        ...
                                        <th> <FontAwesomeIcon icon={faIdBadge}  /> ID cliente</th>
                                ...
                                <tbody>  
                                    {historial.map(item => 
                                        ...
                                        <td className="celda">{item.idCliente}</td>
